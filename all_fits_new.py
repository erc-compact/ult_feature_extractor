...
def main():
    ...
    sine_fit(summed_profile, tag, directory=f'/hercules/scratch/dbhatnagar/Classifier_data_samples/strange_chis/outputs/{tag}')
    sine_squared_fit(summed_profile, tag, directory=f'/hercules/scratch/dbhatnagar/Classifier_data_samples/strange_chis/outputs/{tag}')
    gaussian_fit(summed_profile, tag, directory=f'/hercules/scratch/dbhatnagar/Classifier_data_samples/strange_chis/outputs/{tag}')
    double_gaussian_fit(summed_profile, tag, directory=f'/hercules/scratch/dbhatnagar/Classifier_data_samples/strange_chis/outputs/{tag}')
